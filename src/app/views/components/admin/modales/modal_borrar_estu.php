<div id="borrar_estudi" class="modal">
    <div class="modal-content"> <span class="close" onclick="closeModal('borrar_estudi')">&times;</span>
        ...
        <form id="borrarEstudianteForm"> <!-- Buscar -->
            ...
            <div class="form-group"> <label for="borrar_correo">CORREO</label> <input type="email" id="borrar_correo" readonly> </div> <button type="submit" class="btn btn-danger">Desactivar Estudiante</button> <button type="button" class="btn btn-secondary" onclick="closeModal('borrar_estudi')">Cancelar</button>
        </form>
    </div>
</div>