  ...
  fetch("/teacher/dashboard/registrarAsistenciaDia", {
    ...
    .then(async (res) => {
      ...
      try {
        ...
        alert(
          "Respuesta no válida del servidor al registrar asistencia. Ver consola."
        );
        return;
      }
    ...
    .then((response) => {
      ...
      asistencias.forEach((item) => {
        ...
        switch (item.estado) {
          ...
          default:
            estadoHtml =
              '<span class="badge bg-warning text-dark"><i class="bi bi-file-earmark-text"></i> Excusa</span>';
            break;
        }
