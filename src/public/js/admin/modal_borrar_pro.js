...
function buscarProfesorBorrar() {
    const id = document.getElementById("search_profesor_id").value.trim();
    ...
    document.getElementById("borrar_profesor_fecha_nacimiento").value = profesor.fecha_nacimiento;
    document.getElementById("borrar_profesor_telefono").value = profesor.telefono;
    document.getElementById("borrar_profesor_direccion").value = profesor.direccion;

    alert("Profesor encontrado.");
}

// SUBMIT DEL FORMULARIO
document.getElementById("borrarProfesorForm").addEventListener("submit", function(e) {
    e.preventDefault();
