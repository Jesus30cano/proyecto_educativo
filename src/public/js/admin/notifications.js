/**
 * Sistema de Notificaciones del Administrador
...
async function cargarNotificaciones() {
  try {
    const response = await fetch("/admin/notifications/obtenerNotificacionesPorUsuario", {
      method: "POST",
      headers: {
...
async function marcarComoLeida(id_notificacion) {
  try {
    const response = await fetch("/admin/notifications/marcarNotificacionLeida", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
