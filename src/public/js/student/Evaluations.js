...
const URL_EVALUACIONES = '/student/evaluations/obtenerEvaluacionesPorEstudiante';
...
async function cargarEvaluaciones() {
    try {
        ...
        if (result.status !== 'success') {
            mostrarMensajeEvaluaciones(result.message || 'Error al obtener evaluaciones.', true);
            return;
        }
