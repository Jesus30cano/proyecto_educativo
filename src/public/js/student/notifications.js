/**
 * Sistema de Notificaciones del Estudiante
...
async function cargarNotificaciones() {
  try {
    const response = await fetch("/student/notifications/obtenerNotificacionesPorUsuario", {
      method: "POST",
      headers: {
...
async function marcarComoLeida(id_notificacion) {
  try {
    const response = await fetch("/student/notifications/marcarNotificacionLeida", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
